...
begin
	...
	declare
		...
		ControlInput   	: constant Stream_Element_Array  := ( -- Sets control parameters
			...
			7 => 16#30#, -- 0
			8 => 16#31#, -- input digit 1
			9 => 16#30#, -- input digit 2
			10 => 16#30#, -- input digit 3
			11 => 16#2E#, -- input decimal
			12 => 16#30#, -- input digit 4
			13 => 16#47#, -- G
			14 => 16#0D# -- CR
		);
	...
	begin
		...
		for I in 1 .. Last loop
			...
			if Stream_Element'Image(Buffer(I)) = "50" then
